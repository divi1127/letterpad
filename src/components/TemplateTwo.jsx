  ...
  return (
    <div className="w-full max-w-[800px] min-h-[1131px] bg-white shadow-2xl relative overflow-hidden flex flex-col mx-auto font-['Times_New_Roman']">
      ...
      <div className="px-12 pt-[22px] pb-6 flex-grow flex flex-col z-10">
        ...
        {/* Salutation */}
        {salutation && <p className="text-[14px] text-gray-700 ">{salutation},</p>}

        <div className="flex-grow flex flex-col justify-center -mt-25">
          {/* Heading */}
          {heading && (
            <div className="mb-5">
      ...
      <div className="w-full mt-auto">
        <div className="bg-black flex justify-between items-center px-12 py-4 text-[10.5px] text-white flex-wrap gap-3">

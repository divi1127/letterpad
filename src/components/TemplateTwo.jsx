...
const TemplateTwo = ({ data = {} }) => {
  ...
  return (
    <div id="letter-preview" className="w-full max-w-[800px] min-h-[1131px] bg-white shadow-2xl relative overflow-hidden flex flex-col mx-auto">
      ...
      <div className="px-12 mt-4">
        <div className="text-[9.5px] text-gray-600 flex flex-wrap gap-x-6 gap-y-1.5 font-medium">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span>96298 72195 | 78679 08377</span>
          </div>
          <div className="flex items-center gap-1.5">
            ...
            <span>jodtech11@gmail.com | jodtech.in</span>
          </div>
      ...
      <div className="px-12 py-6 flex-grow flex flex-col z-10">
        ...
        {letterType && (
          <div className="mb-4">
            <span className="bg-black text-white text-[10px] font-bold px-3 py-1 rounded uppercase tracking-widest">
              {letterType}
            </span>
          </div>
        )}
      ...
      <div className="w-full mt-auto">
        <div className="bg-black flex justify-between items-center px-12 py-4 text-[9px] text-white flex-wrap gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span>https://jodtech.in</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-[#0A4F43] font-bold">GSTIN:</span>
            <span>33FAVPR3433JIZ5</span>
          </div>
        </div>
